...
echo
    sleep 2
    echo $cyan":::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
    echo $cyan"::"$yellow"          AUTHOR"$cyan" :"$yellow" MR VIRUS SPM                      "$cyan"::"
    echo $cyan"::"$yellow"          TEAM  "$cyan" :"$yellow" MAFIA TEKNOLOGI INDONESIA         "$cyan"::"
    echo $cyan"::"$yellow"          IG    "$cyan" :"$yellow" mvs.x_x                           "$cyan"::"
    echo $cyan":::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
    echo
sleep 1
